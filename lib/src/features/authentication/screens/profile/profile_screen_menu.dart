      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            child: Obx(() {
              if (profileController.userData.value.email.isNotEmpty) {
                UserModel userData = profileController.userData.value;
                return Column(
                  children: [
                    Stack(
                      children: [
              ...
              } else if (profileController.userData.value.email.isEmpty) {
